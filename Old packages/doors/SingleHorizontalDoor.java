...
******************************
*
* File: SingleHorizontalDoor.java
* 
...
public class SingleHorizontalDoor extends CabinetOpening implements Serializable
{
   /***********************/
   /*** Class Constants ***/
   /***********************/

   public static final String DOOR_TYPE = "Single Horizontal Door";
   ...
   public SingleHorizontalDoor( double[] projectSpecificComponents,
                                double[] singleDoorComponents     ,
                                //double[] horizontalDoorComponents ,
                                int      pDoorNumber              )
   {
