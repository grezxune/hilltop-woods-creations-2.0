...
public class SingleVerticalDoor extends CabinetOpening implements Serializable
{
   /***********************/
   /*** Class Constants ***/
   /***********************/

   public static final String DOOR_TYPE = "Single Vertical Door";
   ...
   public SingleVerticalDoor( double[] projectSpecificComponents,
